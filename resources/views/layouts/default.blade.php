...
<head>
    <meta charset="utf-8">
    <title> ESFOREM </title>
    <meta name="description" content="ESFOREM">
    ...
    <!-- Clock Picker -->
    <link rel="stylesheet" type="text/css" media="screen" href="{{URL::to('js/plugin/clockpicker/bootstrap-clockpicker.min.css')}}">
    ...
    <link rel="apple-touch-icon" href="{{URL::to('img/favicon/favicon.ico')}}">
    <link rel="apple-touch-icon" sizes="76x76" href="{{URL::to('img/favicon/favicon.ico')}}">
    <link rel="apple-touch-icon" sizes="120x120" href="{{URL::to('img/favicon/favicon.ico')}}">
    <link rel="apple-touch-icon" sizes="152x152" href="{{URL::to('img/favicon/favicon.ico')}}">
    ...
    <link href="{{URL::to('js/plugin/video-js/video-js.css')}}" rel="stylesheet">
...
<div id="main" role="main">
    ...
    <div id="loader" class="loader" style="display: none; top:auto;">
        {{--<img src="{{URL::asset('img/logos/logo.png')}}" alt="">--}}
    </div>



    <!-- RIBBON -->
    <div id="ribbon" style="display: flex;flex-wrap:nowrap;justify-content: space-between;" >
       ...
       {{--You can also add more buttons to the
        ...
        <span id="back" class="ribbon-button-alignment pull-right" style="padding-top:3px !important ;">
            @yield('view_buttons')
        </span>
...
<!--Mobile hiden keyboard -->
<script>

    $('body').on(
        'focus', '.input-hide-keyboard',function(){
           $(this).val('');
           $(this).blur();
           $(this).trigger('change');
        }
    ...
    $('body').on('click','.datetimepicker',function(){
        $(this).closest('input').prop('readonly',true);
    });

    $('body').on('blur','.datetimepicker',function(){
        $(this).closest('input').prop('readonly',false);
    });
