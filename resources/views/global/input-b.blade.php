...
@if($type=='text')
        ...
        <div id="@if(isset($block_id)){{$block_id}}@endif"
            ...
            <div class="col-md-10">
                ...
                <div class="">
                    ...
                    @if(isset($icon))<span class="-addon"><i class="{{$icon}}"></i></span>@endif
                </div>
    ...
    @else
        ...
        <div id="@if(isset($block_id)){{$block_id}}@endif" class="form-group  {{ $errors->has($name) ? 'has-error has-feedback' : '' }} margin-bottom-10  @if(isset($col)) col-md-{{$col}} @endif"   style="margin-bottom:16px !important; @if(isset($hidden))display: none @endif " >
        ...
        <div id="@if(isset($block_id)){{$block_id}} @endif" class="form-group @if(isset($col)) col-md-{{$col}} @endif"@if(isset($hidden)) style="display: none"@endif>
            ...
            <div class="col-md-10">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="">
                            <input @if(isset($readonly) && $readonly==true)readonly="readonly" @endif @if(isset($disabled) && $disabled==true)disabled="disabled" @endif id="{{$id}}"  class=" form-control @if(isset($class)){{$class}}@endif"  @if(isset($required) && $required==true) required="required" @endif type="number" name="{{$name}}" placeholder="@if(isset($placeholder)){{ Lang::get($placeholder)  }}@else{{isset($label)?Lang::get($label):null}}@endif" value="{{ old($name, isset($value)?$value:null) }}" @if(isset($mask)))data-mask="{{$mask}}" @endif
...
@if($type=='textarea')
    ...
    @if(isset($aling) && $aling=='horizontal')
        ...
        >
            ...
            id="{{$id}}" name="{{$name}}"   placeholder="@if(isset($placeholder)){{ Lang::get($placeholder)  }}@else{{isset($label)?Lang::get($label):null}}@endif"
                      @if(isset($readonly) && $readonly==true)readonly="readonly" @endif
                      @if(isset($disabled) && $disabled==true)disabled="disabled" @endif
                      class=" form-control @if(isset($class)){{$class}}@endif"
                      @if(isset($required) && $required==true) required="required" @endif
