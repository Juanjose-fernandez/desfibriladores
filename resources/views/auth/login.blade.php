           ...
           @include('site.includes.notifications')
            <div class="col-xs-12 col-sm-12 col-md-6 col-md-offset-3 col-lg-4 col-lg-offset-4 ">
                <div class="well no-padding">
                    <form action="{{ url('/login') }}" id="login-form" class="smart-form client-form" role="form" method="POST">
                        <header class="">
                            Iniciar sesión
                        </header>
                        ...
                        <fieldset>
                            <div class="col-md-12 text-center" style="margin-bottom: 20px">
                                <img class="img-responsive" src="{{URL::to('img/logos/logo.png')}}"  alt="Mother 1.0" >
                            </div>
                                <section>
                                    <div>
                                       ...
                                       {{-- <small class="help-block" data-bv-for="username" data-bv-result="INVALID">{{ $errors->first('username') }}</small>--}}
                                    </div>
                                </section>

                            <section>
                                <div class="{{ $errors->has('password') ? ' has-feedback has-error' : '' }}">
                                    <label class="control-label">Contraseña</label>
                                    <label class="input"> <i class="icon-append fa fa-lock"></i>
                                        <input  class="form-control"  type="password" name="password" required="required" placeholder="Contraseña">
                                        <b class="tooltip tooltip-top-right"><i class="fa fa-lock txt-color-teal"></i> Introduzca su contraseña</b> </label>
                                    <small class="help-block" data-bv-for="password" data-bv-result="INVALID">{{ $errors->first('password') }}</small>
                                    <div class="note">
                                        <a href="{{URL::to('password/reset')}}">¿Olvidaste tu contraseña?</a>
                                    </div>
                                </div>
                            </section>
                            ...
                            <section>
                                <label class="checkbox">
                                    ...
                                    <i></i>Mantener la sesión inicada</label>
                            </section>
                        </fieldset>
                        <footer>
