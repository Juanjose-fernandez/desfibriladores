...
//        $menu = '<ul class="nav nav-pills nav-stacked">';
        ...
        foreach ($categories as $category) {
            $menu .= '<li>';
            $menu .= '<a class="btn btn-labeled btn-default" style="color: white; background-color:'.$category['color'].'" href="'.URL::to('/').'/'.config('chatter.routes.home').'/'.config('chatter.routes.category').'/'.$category['slug'].'">';
